...
# Taper : streamlit run projet_7_5_Dashboard.py
...
import seaborn as sns# STREAMLIT
# Ouvrir le terminal sous anaconda, et changer de repertoire :
# En local : Taper streamlit run main_dashboard.py
...
# X_train_scaled et X_test_scaled
